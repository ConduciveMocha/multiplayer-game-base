...
from server.redis_cache.user_cache import user_is_online,set_user_online,user_from_sid,get_online_users,extend_user_data,set_user_offline,USER_SIG
...
def test_set_user_offline(r_inst,mock_user):
    ...
    returned_user_object = map_dict_signature(r_inst.hgetall(f'user:{user.id}'), USER_SIG)
