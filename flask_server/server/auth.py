...
from server.serverlogging import serverlogger
...
class UserAuthenticator:
    def __init__(self, JWT_ISS=None, JWT_EXP_DELTA_SECONDS=None, JWT_KEY=None, JWT_ALGORITHMS=None):
        self.app = None
    ...
    def verify_jwt(self, token, user_id=None, decoded=False):
        ...
        try:
            ...
            payload = token if decoded else jwt.decode(
                token, key=self.JWT_KEY, algorithms=self.JWT_ALGORITHMS)
