...
from server.responses.errors import make_bad_request, INTERNAL_SERVER_ERROR
from functools import wraps


def required_or_400(required=[], logger=None):
    """Decorator that adds required parameters from the 
       request object to the global context
    """
    if not logger:
        logger = logging.getLogger('required_or_400')
