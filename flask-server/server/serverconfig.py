...
def get_config(cmd_args=None):
    ...
    server_mode_group.add_argument("-p", "--production",help="Run server in production", action="store_true")
    server_mode_group.add_argument("-d", "--debug",help="Run server in debug mode",action="store_true")
    server_mode_group.add_argument("-t",'--testing', help="Run server in testing configuration", action="store_true")
    ...
    key_group.add_argument("-k", "--keys", nargs=2, help="Sets the server secret key and the jwt secret key")
